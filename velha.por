programa
{
	...
	{
			se(pre == "a1" e matriz[0][0] == 0)
			{
				matriz[0][0] = vezDeQuem;
				retorne verdadeiro;
			}
			
			se(pre == "a2" e matriz[1][0] == 0)
			{
				matriz[1][0] = vezDeQuem;
				retorne verdadeiro;
			}
			
			se(pre == "a3" e matriz[2][0] == 0)
			{
				matriz[2][0] = vezDeQuem;
				retorne verdadeiro;
			}

			se(pre == "b1" e matriz[0][1] == 0)
			{
				matriz[0][1] = vezDeQuem;
				retorne verdadeiro;
			}
			
			se(pre == "b2" e matriz[1][1] == 0)
			{
				matriz[1][1] = vezDeQuem;
				retorne verdadeiro;
			}
			
			se(pre == "b3" e matriz[2][1] == 0)
			{
				matriz[2][1] = vezDeQuem;
				retorne verdadeiro;
			}
			se(pre == "c1" e matriz[0][2] == 0)
			{
				matriz[0][2] = vezDeQuem;
				retorne verdadeiro;
				
			}
			se(pre == "c2" e matriz[1][2] == 0)
			{
				matriz[1][2] = vezDeQuem;
				retorne verdadeiro;
			}
			se(pre == "c3" e matriz[2][2] == 0)
			{
